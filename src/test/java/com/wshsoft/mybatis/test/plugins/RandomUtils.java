package com.wshsoft.mybatis.test.plugins;
...
public final class RandomUtils {
	 ...
	 *
	 * @param length
	 *            指定长度。最大36，超出抛异常IllegalArgumentException
	 * @return UUID字符串
	 */
	 ...
	 *
	 * @param length
	 *            指定长度。 正整数，否则超出抛异常IllegalArgumentException
	 * @return 全字母字符串
	 */
	 ...
	 *
	 * @param length
	 *            指定字符串长度。正整数，否则超出抛异常IllegalArgumentException
	 * @return 字母数字混合字符串
	 */
