...
public class TenantSqlTest {
    ...
    public void deleteJoin() {
        ...
        Assert.assertEquals("DELETE gc FROM guide_category AS gc LEFT JOIN guide AS g ON g.id_guide = gc.id_guide WHERE tenant_id = 1000 AND g.title IS NULL LIMIT 5", sqlInfo.getSql());
    }
