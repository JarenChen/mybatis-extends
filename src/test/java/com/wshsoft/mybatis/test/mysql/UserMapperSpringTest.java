...
public class UserMapperSpringTest {
	 ...
	 * 
	 * @Test public void testQueryAll(){ userMapper.selectList(null); }
	 * 
	 * @Test public void testSelectList(){ List<User> ul2 =
	 * userMapper.selectList(new EntityWrapper<User>(null, "age,name")); for
	 * (User anUl2 : ul2) { print(anUl2); } }
	 */
