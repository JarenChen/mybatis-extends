...
public class MybatisMapperRefresh implements Runnable {
	...
	/**
	 * see
	 * com.wshsoft.mybatis.spring.MybatisMapperRefresh#MybatisMapperRefresh(org.
	 * apache.ibatis.session.SqlSessionFactory, int, int, boolean)
	 * 
	 ...
	 * see
	 * com.wshsoft.mybatis.spring.MybatisMapperRefresh#MybatisMapperRefresh(org.
	 * apache.ibatis.session.SqlSessionFactory, boolean)
	 * 
	 * @param mapperLocations
	 * @param sqlSessionFactory
	 * @param enabled
